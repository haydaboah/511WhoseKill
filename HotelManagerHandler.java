...
public class HotelManagerHandler {
    ...
    public void level3(int choice) {
        ...
        switch (choice) {
            case 1:
                System.out.println(hm.chefChosen(characters[0].getRoom()));
                break;
            case 2:
                System.out.println(hm.maidChosen(characters[1].getRoom()));
                break;
            case 3:
                System.out.println(hm.senChosen(characters[2].getRoom()));
                break;
            case 4:
                System.out.println(hm.impChosen(characters[3].getRoom()));
                break;
            case 5:
                System.out.println(hm.danChosen(characters[4].getRoom()));
                break;
            case 6:
                System.out.println(hm.goonChosen(characters[5].getRoom()));
                break;
            default:
