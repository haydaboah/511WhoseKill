...
public class Hotel 
{
	...
	//Row1
	Room C1    = new Room("C1","Closet",  new String[] {"East"},"");
	Room H1    = new Room("H1","Hallway", new String[] {"East","South","West"},"");
	Room B1    = new Room("B1","Ballroom",new String[] {"West"},"");
	
	//Row2
	Room R1    = new Room("R1","Room",    new String[] {"East"},"");
	Room H2    = new Room("H2","Hallway", new String[] {"North","East","South","West"},"");
	Room R2    = new Room("R1","Room",	  new String[] {"West"},"");
	
	//Row3
	Room R3    = new Room("R3","Room",    new String[] {"East"},"");
	Room H3    = new Room("H3","Hallway", new String[] {"North","East","South","West"},"");
	Room R4    = new Room("R4","Room",    new String[] {"West"},"");
	
	//Row4
	Room R5    = new Room("R5","Room",    new String[] {"East"},"");
	Room H4    = new Room("H1","Hallway", new String[] {"North","East","South","West"},"");
	Room R6    = new Room("R6","Room",    new String[] {"West"},"");
	
	//Row5
	Room K1    = new Room("K1","Kitchen", new String[] {"East"},"");
	Room H5    = new Room("H1","Hallway", new String[] {"North","East","South","West"},"");
	Room R7    = new Room("R7","Room",    new String[] {"West"},"shot");
	
	//Row6
	Room Rr1   = new Room("Rr1","Restaurant", new String[] {"East"},"");
	Room Lobby = new Room("Lobby","Lobby",    new String[] {"North","East","West"},"");
	Room C2    = new Room("C2","Closet",      new String[] {"West"},"");
	...
	public Hotel()
	{
		/*Room[][] hotel = 
		{
				{H1,  H2,  H3,    H4,  H5,  R1 },   //  Clos    Hall    Ball 1
			    {H6,  K1,  H7,    R2,  H8,  K2 },   //  Room    Hall    Room 2
			    {H9,  C1,  H10,   R11, H11, R12},   //  Room    Hall    Room 3
			    {H12, R13, H13,   R14, H14, R15},   //  Room    Hall    Room 4
			    {H15, R16, H16,   C2,  H17, C3 },   //  Kitch   Hall    Room 5       
			    {H18, H19, Lobby, H20, H21, B1 },   //  Rest    Lobby   Clos 6
		};*/
