...
public class Dialogue {
    ...
    private String chef, maid, goon, dancer, senator, imperialist;
    private Random rand;

    public Dialogue(String chef, String maid, String goon, String dancer, String senator, String imperialist) {
        rand = new Random();
        this.chef = chef;
        this.maid = maid;
        this.goon = goon;
    ...
    public String otherPeopleHere(String charName) {
        ...
        if (charName.equals(chef)) {
            ...
            String r91B = "\"" + imperialist + " and " + chef + " share a puff together some nights, but all they talk about is their time in France.\"" ;
        ...
        } else if (charName.equals(senator)) {
            String r93A = "\"" + senator + " likes to flash his timepiece a lot. It\'s the last bit of glamour he has left.\"";
            String r93B = "\"" + senator + " drinks on the roof late at night. You can hear him stumbling down the stairs, after.\"";
        ...
        } else if (charName.equals(dancer)) {
